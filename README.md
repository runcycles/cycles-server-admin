...
Administrative API for the Complete Budget Governance System, aligned with [Cycles Protocol v0.1.25.24](https://github.com/runcycles/cycles-protocol/blob/main/cycles-governance-admin-v0.1.25.yaml).
